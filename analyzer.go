...
func (wa *wslAnalyzer) flags() flag.FlagSet {
	...
	flags.IntVar(&wa.config.MaxAllowedStatementsAboveBlock, "max-allowed-statements-above-block", 1, "Max statements above for|if block before requiring newline before block")
